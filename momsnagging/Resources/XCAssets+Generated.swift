...
internal enum Asset {
  internal enum Assets {
    ...
    internal static let namesettingConfirmM = ImageAsset(name: "_namesetting_confirm_m")
    internal static let namesettingConfirmS = ImageAsset(name: "_namesetting_confirm_s")
