...
internal enum Asset {
  internal enum Assets {
    ...
    internal static let gradeTip1 = ImageAsset(name: "grade_tip_1")
    internal static let gradeTip2 = ImageAsset(name: "grade_tip_2")
    internal static let gradeTip3 = ImageAsset(name: "grade_tip_3")
    internal static let gradeTip4 = ImageAsset(name: "grade_tip_4")
    internal static let gradeTip5 = ImageAsset(name: "grade_tip_5")
    internal static let gradeTip6 = ImageAsset(name: "grade_tip_6")
